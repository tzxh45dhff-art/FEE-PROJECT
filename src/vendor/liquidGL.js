 ...
 *
 * -----------------------------------------------------------------------------
 * Vendored verbatim. Not on npm, so it lives here rather than in node_modules.
 * Do not reformat — keeping it byte-identical to upstream is what makes it
 * possible to diff against a future release.
 *
 * It expects two globals: `html2canvas` and `window`. See src/lib/liquidGlass.ts
 * for the bootstrap that provides them and the React lifecycle around it.
 * -----------------------------------------------------------------------------
 */
